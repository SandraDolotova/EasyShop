...
public class DBMapper {
  ...
  //  String sql10 = "UPDATE sales_products SET product_quantity = ((SELECT (product_quantity) FROM sales_products WHERE product_id = ?) - (SELECT (product_quantity) FROM shopping_cart WHERE product_id = ?)";

//' " + productID + " ' ";
    //  static final String sql6 = "UPDATE sales_products SET product_price = product_price + 50";
